...
Base neutra em tons de cinza/preto, com acentos coloridos usados com significado, não é "cor por decoração", cada uma marca um estado diferente da interface.
